...
from .subagents import creator_agent, surfer_agent, searcher_agent, reviewer_agent, pm_final_report_agent
import os
...
prepare_team_agent = ParallelAgent(
    ...
    description="searcher/surfer/creator を並列に実行する。",
    sub_agents=[searcher_agent, surfer_agent, creator_agent],
)
